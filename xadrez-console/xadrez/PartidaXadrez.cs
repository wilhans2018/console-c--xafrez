...
namespace xadrez {
    class PartidaXadrez {
        ...
        public void desfazMovimento(Posicao origem, Posicao destino, Peca pecaCaputada) {
            ...
            //#jogada especial rn passant
            if(p is Peao) {
                if(origem.coluna != destino.coluna && pecaCaputada == vulneravelEnPassant){
        ...
        private void colocarPecas() {
            ...
            colocarNovaPeca('a', 8, new Peao(tab, Cor.Branca, this));
            colocarNovaPeca('b', 8, new Peao(tab, Cor.Branca, this));
            colocarNovaPeca('c', 8, new Peao(tab, Cor.Branca, this));
            colocarNovaPeca('d', 8, new Peao(tab, Cor.Branca, this));
            colocarNovaPeca('e', 8, new Peao(tab, Cor.Branca, this));
            colocarNovaPeca('f', 8, new Peao(tab, Cor.Branca, this));
            colocarNovaPeca('g', 8, new Peao(tab, Cor.Branca, this));
            colocarNovaPeca('h', 8, new Peao(tab, Cor.Branca, this));
